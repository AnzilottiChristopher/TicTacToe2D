...
public class GameManager : MonoBehaviour
{
    ...
    //[SerializeField] private int[] index = new int[9];
    

    //Below is for save states
    ...
    // public void SaveIndexState(SaveStates state)
    // {
    ...
    // }
    //
    // public SaveStates LoadIndexState()
    // {
    ...
    //Below is for game functionality
    private void Start()
    {
        setBoard();
        drawCounter = 0;
